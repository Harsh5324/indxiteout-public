...
export default function SingleSolutions() {
    const { ID } = useParams();
    ...
    useEffect(() => {
        const getPost = async () => {
            Api.getSingleSolution(path).then((res) => {
                                                                                ...
                                                                                post.use_cases
                                                                                    ? post.use_cases.map(
                                                                                          (
                                                                                              ...
                                                                                              return use_cases.title &&
                                                                                                  use_cases.subtitle ? (
                                                                                                  <div
                                                                                                      className="align-items-stretch mb-3 col-lg-4 col-md-4 col-sm-6 col-xs-12 elementor-column elementor-col-33 elementor-inner-column elementor-element elementor-element-1e1c1c4"
                                                                                                      data-id="1e1c1c4"
                                                                                                      style={{
                                                                                                          paddingBottom: 8,
                                                                                                      }}
                                                                                                      data-element_type="column el"
                                                                                                  >
                                                                                                      <div
                                                                                                          style={{
                                                                                                              border: "none",
                                                                                                          ...
                                                                                                          className="align-items-stretch card elementor-column-wrap elementor-element-populated"
                                                                                                      >
                                                                                                          <div className="elementor-widget-wrap p-0">
                                                                                                              <div
                                                                                                                  className="elementor-element mb-0 elementor-element-26f691f2 elementor-widget elementor-widget-stm_info_box"
                                                                                                                  data-id="26f691f2"
                                                                                                                  data-element_type="widget"
